...
function loadDepensesPage(c) {
    ...
    html += '<div class="content-card" style="margin-bottom:30px;">';
    html += '<div class="card-header">';
    html += '<h3><i class="fas fa-money-bill-wave"></i> Dépenses <span id="depensesTotalDisplay" style="font-size:0.9rem;color:#14B8A6;"></span></h3>';
    html += '<div style="display:flex; gap:10px; align-items:center; flex-wrap:wrap;">';
...
var depenseCategories = {
    ...
    "Maintenance": ["Réparation", "Climatisation", "Plomberie", "Matériel"],
    "Marketing": ["Publicité", "Flyers", "Promotions", "Réseaux sociaux"],
    "Administratif": ["Comptable", "Logiciel", "Frais bancaires", "Assurances"],
    "Transport": ["Carburant", "Entretien", "Frais de livraison"],
    "Taxes": ["Taxes", "Impôts"]
};
